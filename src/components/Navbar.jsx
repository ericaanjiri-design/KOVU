...
import kovLogo from '../assets/kov.png';
    ...
    <nav
      ...
      style={{
        ...
        borderBottom: scrolled
          ...
          : '1px solid rgba(200,169,107,0.08)',
        boxShadow: scrolled
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-10 flex items-center justify-between h-16 md:h-20">
        ...
        >
          <img
            src={kovLogo}
            alt="Kovu Afrika"
            style={{ height: '56px', width: '56px', objectFit: 'cover', borderRadius: '50%' }}
          />
        ...
        <div className="hidden lg:flex items-center gap-1">
          ...
          <div
            ...
            style={{ background: 'rgba(200,169,107,0.2)' }}
          />
